                ...
                <div class="card-body rounded-lg">
                    ...
                    <form action="{{route('loans.kalkulasi', $type->id) }}" method="post">
                        ...
                        <div class="input-group mb-4 shadow-sm">
                            ...
                            <input type="text" name="show_jp" id="show_jp" class="form-control border-0 text-muted"
                        ...
                        <div class="input-group mb-4 mt03 shadow-sm">
                            <div class="input-group-prepend">
                                <div class="input-group-text border-0 bg-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20">
                                        <path fill="#eeeeee"
                            ...
                            <input type="number" name="lama_angsuran" id="lama_angsuran" class="form-control border-0 text-muted" value="{{ $request->lama_angsuran }}" disabled>
